...
import com.example.mahmoudheshmat.missing.Adapters.Profile_Adapter;
...
public class imageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        adapter = new Profile_Adapter(this.getContext(), data_list, recyclerView);
    ...
    private void JsonData(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseURL.imageprofile_url, new Response.Listener<String>() {
            @Override
                ...
                if(response.equals("nofound")){
                    ...
                    try {
                        ...
                        for (int x = 0; x < list.length(); x++) {
                            ...
                            String childData_id = jsonObject.getString("childData_id");
                            ...
                            childItem items = new childItem(child_name, age, skinColor, hairColor, eyeColor, length, Lostdate, ImagePath,
                                    addressLine, city, country, user_id, uploadDate, childData_id, image_id, location_id, subject_id, key);
